...
export default function MiniPlayer() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 index-z:-1 lg:left-72 bg-gradient-to-t from-black to-gray-900 border-t border-gray-800 z-50">
      <div className="flex items-center justify-between px-4 py-3 max-w-screen-2xl mx-auto">
        ...
        {/* Right: Volume (hidden on small screens, shown on md+)
        <div className="hidden md:flex items-center gap-3 flex-1 justify-end">
          <Volume2 size={22} className="text-gray-400" />
          <div className="w-24 bg-gray-700 rounded-full h-1">
            <div className="bg-primary h-1 rounded-full w-3/4 transition-all" />
          </div>
        </div> */}
      </div>
